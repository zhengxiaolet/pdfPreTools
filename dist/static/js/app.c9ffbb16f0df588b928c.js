...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(160);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_common__ = __webpack_require__(143);
  ...
  methods: {
    ...
    getPdfImgList: function (num) {
      ...
      let info = {
        head: {
          transCode: "PT600666",
          transDate: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__js_common__["a" /* getDate */])(),
          transTime: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__js_common__["b" /* getHms */])(),
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__js_common__["c" /* postJsonSLB */])("policyElecUrl/pdfToPic", info, data => {
    ...
    nextBtn: function () {
      const { title, headInfo, pdfInfo, policyInfo } = this.$route.query;
      this.name = policyInfo ? policyInfo.fileName : "我已查阅电子保险合同并阅读其内容";
      if (this.checkState) {
        let info = {
          head: {
            transCode: "MSL6068",
          ...
          whetherCheck: "Y",
          checkTime: __WEBPACK_IMPORTED_MODULE_3_moment___default()(new Date()).format("YYYY-MM-DD hh:mm:ss")
        };
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__js_common__["d" /* postJsonML */])("order/receiptCheckRead", info, data => {
          if (data.resultCode == "10") {
...
/* harmony export (immutable) */ __webpack_exports__["b"] = getHms;
/* harmony export (immutable) */ __webpack_exports__["c"] = postJsonSLB;
/* harmony export (immutable) */ __webpack_exports__["d"] = postJsonML;
/* unused harmony export wxConfig */
/* unused harmony export goRelease */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_ipconfig_js__ = __webpack_require__(144);
...
//闪联保接口
function postJsonSLB(url, param, callback) {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
        type: 'post',
        url: __WEBPACK_IMPORTED_MODULE_0__js_ipconfig_js__["a" /* SLB */] + url,
        timeout: '30000',
...
//麦粒接口
function postJsonML(url, param, callback) {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
        type: 'post',
        url: __WEBPACK_IMPORTED_MODULE_0__js_ipconfig_js__["b" /* ML */] + url,
        timeout: '30000',
        data: JSON.stringify(param),
        dataType: "json",
        contentType: 'application/json',
...
function share(url, param, callback, state) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
        type: 'get',
        url: __WEBPACK_IMPORTED_MODULE_0__js_ipconfig_js__["c" /* WXChatShare */] + url,
        timeout: '30000',
...
//微信分享
function wxConfig(info) {
    share("interface/wx/getJsSDKConfig", {
        "appId": info.appId,
        ...
        wx.config({
            ...
            // jsApiList: ['onMenuShareAppMessage', 'uteAppMessageShareData'] // 必填，需要使用的JS接口列表，所有JS接口列表见附录2
        ...
        wx.ready(function () {
            ...
            //     link: filterUrl(window.location.href), // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
            //     imgUrl: IMGURL + info.imgUrl, // 分享图标
            //     success: function () {
            //         // 设置成功
            //     }
            // });
            ...
            wx.onMenuShareAppMessage({
                title: info.title, // 分享标题
                desc: info.desc, // 分享描述
                link: filterUrl(info.shareUrl), // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
                imgUrl: __WEBPACK_IMPORTED_MODULE_0__js_ipconfig_js__["d" /* IMGURL */] + info.imgUrl, // 分享图标
                success: function () {
                    // 设置成功
                }
            });
...
function goRelease(res) {
    // 大版本页面的发布挡板跳转页面
    let str = res.resultMsg;
    let newArr = str.split("#");
    let title = encodeURIComponent(newArr[0]); // 标题
    let content = encodeURIComponent(newArr[1]); // 发布内容
    let startTime = encodeURIComponent(newArr[2]); // 开始时间
    let endTime = encodeURIComponent(newArr[3]); // 结束时间
    // 跳转地址，根据自己项目文件路径进行修改
    let newURL = `${__WEBPACK_IMPORTED_MODULE_0__js_ipconfig_js__["d" /* IMGURL */]}zzfw/static/bafflePage.html?title=${title}&content=${content}&startTime=${startTime}&endTime=${endTime}`;
 ...
 * 这是IP配置文件
 */
//测试环境 WXButtonHref 是微信菜单入口链接   IPADDRESSURL 老服务端地址

const IPLOCATION = "https://test.jklife.com/jkbc/";
/* unused harmony export IPLOCATION */

const IPLOCATION2 = "https://test.jklife.com/api/micro-serv-wechat-app/";
/* unused harmony export IPLOCATION2 */

const IPADDRESSURL = "https://test.jklife.com/jkds/";
/* unused harmony export IPADDRESSURL */

const WXButtonHref = "https://test.jklife.com/zzfw/weixin_zzfw.html?jack=identification";
/* unused harmony export WXButtonHref */

const WXShare = "https://test.jklife.com/zzfw/";
/* unused harmony export WXShare */

const WXGetOpenid = "https://test.jklife.com/publicService/#/WX/code?project=ZZFW20170701&inletCode=zzfw01";
/* unused harmony export WXGetOpenid */

const WXChatShare = "https://test.jklife.com/rear-ms/";
/* harmony export (immutable) */ __webpack_exports__["c"] = WXChatShare;

const SLB = "https://test.jklife.com/api/micro-serv-light-trans/";
/* harmony export (immutable) */ __webpack_exports__["a"] = SLB;

const ML = "https://test.jklife.com/api/micro-serv-msale-app/";
/* harmony export (immutable) */ __webpack_exports__["b"] = ML;

const IMGURL = "https://test.jklife.com/";
/* harmony export (immutable) */ __webpack_exports__["d"] = IMGURL;

const APPID = "wxfee39ae209983e48";
/* unused harmony export APPID */

const API_CA = "https://test.jklife.com";
/* unused harmony export API_CA */
 //ca下单地址
const API_MEDICAL = "https://plusapitest.miaohealth.net/v2/user/third/report?open_appid=mpgmwzvk3q3seqvwra";
/* unused harmony export API_MEDICAL */


const IPLOCATION3 = "https://test.jklife.com/zuul/api/micro-serv-wechat-app/";
/* unused harmony export IPLOCATION3 */
...
!function (e, t) {
  ...
  }, "function" == "function" && __webpack_require__(161) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
    return k;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vodal__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vodal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_vodal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__store__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_mint_ui_lib_style_css__ = __webpack_require__(134);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_mint_ui__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vue_photo_preview__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vue_photo_preview___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_vue_photo_preview__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_vue_photo_preview_dist_skin_css__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_vue_photo_preview_dist_skin_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_vue_photo_preview_dist_skin_css__);
...
__webpack_require__(131); //移动端页面适配
__webpack_require__(130); //测试弹框去除域名
__webpack_require__(132); //错误机制



__WEBPACK_IMPORTED_MODULE_0_vue__["default"].component(__WEBPACK_IMPORTED_MODULE_6_mint_ui__["Loadmore"].name, __WEBPACK_IMPORTED_MODULE_6_mint_ui__["Loadmore"]);
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].config.productionTip = false;
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].component(__WEBPACK_IMPORTED_MODULE_3_vodal___default.a.name, __WEBPACK_IMPORTED_MODULE_3_vodal___default.a);
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_7_vue_photo_preview___default.a);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._l((_vm.pdfImgList), function(item, key) {
    return _c('div', {
      key: key,
      staticClass: "imgBox"
    }, [_c('img', {
    ...
    staticClass: "mint-loadmore-bottom bottomTxt",
    slot: "bottom"
  }, [_vm._v(_vm._s(_vm.showAllImg ? '已加载所有图片' : '加载中，请您稍候'))])], 2), _vm._v(" "), (_vm.showCheckBOx) ? _c('div', {
    staticClass: "floatBtm"
  }, [_c('div', {
    staticClass: "checkBox"
  }, [_c('i', {
    class: _vm.checkState ? 'checkIcon' : 'checkIcon1',
    on: {
      "click": function($event) {
        _vm.changeState()
      }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_pdfPre__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_pdfPre___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__view_pdfPre__);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    ...
    //保单回执  -- 预览页
    {
        path: '/pdfPre',
        name: 'pdfPre',
        component: __WEBPACK_IMPORTED_MODULE_2__view_pdfPre___default.a
    }]
}));
